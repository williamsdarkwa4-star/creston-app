...
def create_app():
    ...
    # Render PostgreSQL
    if database_url:
        # Some PostgreSQL URLs can start with postgres://.
    ...
    #
    # This means you do NOT need Render Shell just to
    # create the tables.
    #
    ...
    def dashboard():
        ...
        invs = (
            Investment.query
            .filter_by(user_id=current_user.id)
            .order_by(Investment.start_at.desc())
            .all()
        )
        ...
        def inv_status(inv):
            ...
            matured = (
                elapsed_days >= inv.duration_days
            )
    ...
    def invest():
        ...
        if form.validate_on_submit():
            ...
            # Check minimum
                ...
                flash(
                    f"Minimum for this plan is ${plan[3]}",
                    "warning"
                )
    ...
    def redeem(inv_id):
        ...
        if elapsed_days < inv.duration_days:
            ...
            flash(
                "Investment redeemed and payout credited "
                "to income balance",
                "success"
            )
    ...
    def gift_code():
        ...
        if form.validate_on_submit():
            ...
            if not gc:
                ...
                if (
                    gc.expires_at
                    and gc.expires_at < datetime.utcnow()
                ):
